  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const formBody = new URLSearchParams({
        "entry.1018100592": formData.name,
        "entry.1460554123": formData.email,
        "entry.1950935736": formData.phone,
        "entry.35585859": formData.course,
        "entry.169273033": formData.message,
      });

      const response = await fetch(
        "https://docs.google.com/forms/d/e/1FAIpQLSd_xPFJV7tiG__l8Te6C70y5xlHwFjOVyYAbFoAXpORofF_Sw/formResponse",
        {
          method: "POST",
          body: formBody,
          mode: "no-cors",
